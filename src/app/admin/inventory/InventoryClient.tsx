          ...
          {showAddForm && (
            <div className="flex items-center gap-2">
              <input
                ...
                className="h-8 px-2 rounded-md text-xs bg-[oklch(0.12_0.01_260)] border border-[rgba(255,255,255,0.1)] text-[var(--text-primary)] w-36"
        ...
        {!showHistory ? (
          ...
          <div className="bg-[oklch(0.11_0.01_260)] backdrop-blur-sm rounded-xl border border-[rgba(255,255,255,0.07)] shadow-lg overflow-hidden">
            <div className="flex flex-wrap items-center gap-3 px-4 py-3 border-b border-[rgba(255,255,255,0.06)] bg-[oklch(0.10_0.01_260)]">
              ...
              <input type="date" value={historyFrom} onChange={(e) => setHistoryFrom(e.target.value)} className="h-8 px-2 rounded-md text-xs bg-[oklch(0.12_0.01_260)] border border-[rgba(255,255,255,0.1)] text-[var(--text-primary)]" />
              <span className="text-xs text-[var(--text-muted)]">to</span>
              <input type="date" value={historyTo} onChange={(e) => setHistoryTo(e.target.value)} className="h-8 px-2 rounded-md text-xs bg-[oklch(0.12_0.01_260)] border border-[rgba(255,255,255,0.1)] text-[var(--text-primary)]" />
            ...
            : <div className="overflow-x-auto"><table className="w-full"><thead><tr className="border-b border-[rgba(255,255,255,0.08)] bg-[oklch(0.10_0.01_260)]"><th className="sticky left-0 z-10 bg-[oklch(0.10_0.01_260)] py-2.5 px-3 text-left text-[11px] font-semibold text-[var(--text-muted)] uppercase tracking-wider min-w-[120px]">Date</th>
            ...
            {history.map((entry) => <motion.tr key={entry.date} className="border-b border-[rgba(255,255,255,0.06)] hover:bg-white/[0.02]" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.15 }}>
              <td className="sticky left-0 z-10 bg-[oklch(0.11_0.01_260)] py-3 px-3 text-xs font-medium text-[var(--text-primary)] whitespace-nowrap">{new Date(entry.date + "T00:00:00Z").toLocaleDateString("en-US", { month: "short", day: "numeric" })}</td>
